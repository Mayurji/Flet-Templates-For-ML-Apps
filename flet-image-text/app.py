...
global feature_extractor, tokenizer, device
...
def main(page: ft.Page):
    ...
    def extract_text(e):
        if page.image_field.src:
            page.text_field.value = generate_caption(page.image_field.src)
            page.update()
        else:
            on_error()
    ...
    page.appbar = ft.AppBar(
        title=ft.Text("Image Captioning", color=ft.colors.WHITE),
        center_title=True,
    ...
    test_image_file_path = f'assets/uploads/surf.jpg'
    ...
    page.text_field = ft.Text(
        value=generate_caption(test_image_file_path)
    )
